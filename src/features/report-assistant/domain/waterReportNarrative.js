...
export function buildWaterConclusion(reportType, analytics = {}) {
  ...
  return failed
    ...
    : unassessed
      ...
      : `Pemeriksaan ${subject} telah dilaksanakan sebanyak ${numberId(total)} kali. Seluruh parameter yang dicatat diberi status memenuhi oleh petugas; cocokkan kembali dengan laporan laboratorium sebelum menetapkan kesimpulan akhir.`;
}
